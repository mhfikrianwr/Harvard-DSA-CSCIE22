...
public class Puzzle {
    ...
    private boolean[][] rowHasValue; // exampel if row 1 has value 3 then rowHasValue[1][3] = true
    ...
    public Puzzle() {
        ...
        this.colHasValue = new boolean[9][10];
        this.rowHasValue = new boolean[9][10];
    }
